...
class Tugas1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("My Profile"), backgroundColor: const Color.fromARGB(255, 2, 116, 209)),
      body: Column(
        ...
        children: [
          ...
          Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Text("Saat ini saya sedang belajar flutter", style: TextStyle(fontSize: 15))
            ]
          )
